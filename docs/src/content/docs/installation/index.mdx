...
2.  Install the repository by adding it to your sources list:
    ...
    <Tabs>
      <TabItem label="Debian">
        ```bash echo "deb [signed-by=/etc/apt/keyrings/apt-swarm.asc]
        https://neuroverse-fm.github.io/apt-swarm/ bookworm main" | sudo tee
        /etc/apt/sources.list.d/apt-swarm.list ```
      </TabItem>
      <TabItem label="Ubuntu">
        ```bash echo "deb [signed-by=/etc/apt/keyrings/apt-swarm.asc]
        https://neuroverse-fm.github.io/apt-swarm/ noble main" | sudo tee
        /etc/apt/sources.list.d/apt-swarm.list ```
      </TabItem>
    </Tabs>
